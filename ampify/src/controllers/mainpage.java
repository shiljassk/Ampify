...
ArrayList<String> memberlists =new ArrayList<>();
    ...
    private void initComponents() {
        ...
        resultmenu.setModel(new javax.swing.AbstractListModel<String>() {
                        ...
                        .addGroup(searchcardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(searchcardLayout.createSequentialGroup()
                                ...
                                .addGroup(searchcardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(filterlanguage, 0, 127, Short.MAX_VALUE)))
                            .addGroup(searchcardLayout.createSequentialGroup()
                                .addGap(31, 31, 31)
    ...
    private void filterbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterbuttonActionPerformed
        // TODO add your handling code here:
        String artist = (String)filterartist.getSelectedItem();
        String genre = (String)filtergenre.getSelectedItem();
        String language = (String)filterlanguage.getSelectedItem();
        
        String name = filtername.getText();
        if(artist ==null && genre ==null && language ==null && name ==null )
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                SearchSongRequest searchSongRequest=new SearchSongRequest(artist,genre,language,name);
                try {
